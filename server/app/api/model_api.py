...
def get_current():
    res = ClassifyService.CURRENT_MODEL_NAME

    if ClassifyService.MODEL is not None and ClassifyService.MODEL.names is not None:
        res += ". Class: "+str(ClassifyService.MODEL.names)
